    ...
    if 'q' in request.GET:
        ...
        #    erros.append(u'Digite no máximo 80 caracteres.')
            ...
            if isbn:
                ...
                pubs = Publicacao.objects.filter(titulo__startswith=q)
...
def catalogar(request):
    ...
    if request.method == 'POST':
        ...
        if formulario.is_valid():
            ...
            return HttpResponseRedirect('/busca/?q='+urlquote(titulo))   
    else:
...
def editar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if formulario.is_valid() and formset.is_valid():
            ...
            formset.save()
            titulo = formulario.cleaned_data['titulo']
            return HttpResponseRedirect('/busca/?q='+'?q='+urlquote(titulo))
    else:
